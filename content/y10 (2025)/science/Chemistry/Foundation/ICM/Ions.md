...
- When atoms have no net charge, they are not ionic.$^\fbox{requires review}$
...
## Formation of Ions
- Atoms will lose or gain electrons to get a full valence shell. (See [[Basics of Electronic Configuration|here]] for a basic rundown of a valence shell.)
- There are specific groups in the periodic table that are able to achieve a full outer shell through different methods.
	...
	- Group 13 (Aluminium only)
		- Lose three valence electrons for $Al^{3+}$
